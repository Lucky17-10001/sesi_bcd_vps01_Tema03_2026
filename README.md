...
| Usuário | estado | varchar | 20 | Status do usuário |
| Servidor | id | int | 11 | Identificador, PK, Auto incrementável |
| Servidor | nome | varchar | 100 | Nome do servidor |
| Servidor | hostname | varchar | 100 | Nome do host do servidor |
| Servidor | ip | varchar | 15 | IP do servidor |
...
| Conta de Acesso | login_conta | varchar | 50 | Login da conta de acesso |
| Conta de Acesso | estado | varchar | 20 | Status da conta de acesso |
...
| Perfil | nivel acesso | varchar | 10 | Nivel de acesso |
...
| Acesso | estado | varchar | 20 | Status da autorização de acesso |
